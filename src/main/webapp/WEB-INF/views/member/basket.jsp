		...
		function che(event) {
		 ...
		 // 체크 되었을때
		  if(event.target.checked)  {
			...
			/*   console.log( typeof(p_idx.value) ) */
	...
	<c:forEach var="b" items="${b_list}">
	    <tr align="center" height="50">
	        ...
	        <td style="border-bottom: 1px solid #BDBDBD">
		        ...
		        <input class="price" value="<f:formatNumber value='${b.price }' type='number'/>" style="border:0 solid black; text-align: center;" 
		          size="5px" onfocus="this.blur()" readonly> 
	        </td>
	        <td style="border-bottom: 1px solid #BDBDBD">
				<form>
