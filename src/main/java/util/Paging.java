...
public class Paging {
	public static String getPaging(String pageURL,int nowPage, int rowTotal,int blockList, int blockPage){
		...
		//String : immutable(불변)
		//기존 문자열에 이어붙이면 버리고 메모리를 새로 할당 받는다.
		//문자열이 많은 경우 성능이 좀 떨어진다.
		
		//StringBuffer : muttable(변화)
...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append( startPage-3 );
			sb.append("'><img src='resources/images/btn_prev.gif'></a>");
		}
		else
			sb.append("<img src='resources/images/btn_prev.gif'>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='resources/images/btn_next.gif'></a>");
		}
		else
			sb.append("<img src='resources/images/btn_next.gif'>");
//---------------------------------------------------------------------------------------------------------------------	    
